      ...
      <footer className="site-footer footer-dark">
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <h2 className="sx-f-title">Feel Free To Reach Us Out.</h2>
              </div>
              <div className="col-lg-6 col-md-12">
                  ...
                  <form>
                    <div className="sx-nl-form-inner">
                      <input
                        ...
                        placeholder="support@devrolin.com"
                      />
            ...
            <div className="row">
              ...
              <div className="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12 col footer-col-3">
                <div className="widget widget_info">
                  <h4 className="sx-f-title">Contacts</h4>
                  <ul>
                    <li>
        ...
        <div className="sx-f-bottom-section">
          ...
          <div className="sx-f-copy">
            © 2024 by <NavLink to="/index">DevRolin.</NavLink> All rights
            reserved.
          </div>
        </div>
        {/* FOOTER COPYRIGHT */}
